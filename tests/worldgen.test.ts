...
describe('authored middle island', () => {
  ...
  it('loads Blender-authored primitive colliders and two walkable ramps', () => {
    expect(gen.centralStructures.filter(part => !/^(Combat_|Poi_)/.test(part.name))).toHaveLength(99);
