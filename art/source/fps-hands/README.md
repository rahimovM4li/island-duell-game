...
It sculpts shallow knuckle contours into that mesh, uses subtle leather panels
on those contours, raises the leather wrist cuff, and exports a restrained woven
grain with glancing leather highlights.
